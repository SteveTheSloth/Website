  ...
  return (
    <>
      <Layout about>
        ...
        After finishing high school, I was very unsure about potential career paths. I therefore took a year off of formal education and started working as a voluntary carer in a workshop
        for people with additional needs. While this was a great experience, I always new that I wanted to pursue an academic education afterwards. During the year of working in said workshop,
        I had become very interested in politics, but decided to pursue a degree with better potential job security anyways. I started to study engineering at the Technical University 
        Berlin. This turned out to be so far off my interests at the time that I knew after roughly a year of working towards my degree that it did not make sense for me to pursue it any further.
        I switched to a degree in Politics and Economics at the University of Potsdam and quickly realised that this had been the right call. I was awarded the equivalent of a 
        ...
        for them on a part-time basis in their Frankfurt office. I continued working there until I left Frankfurt for another semester abroad in Rovaniemi, Finland. I could not have chosen a better time
        for studying abroad, as the following semester was interrupted by the beginning of the Covid-19 pandemic which brought all exchange programmes to a halt. After returning to Frankfurt I started a new
        ...
        assistance with regards to educational organisation and the University's administration. While this programme had initially been designed to be delivered in person, the Covid-19 pandemic forced me and my colleagues
        to adapt on the fly and redesign our corses to distance learning. During this time I also finished the last of my own courses and started working on my Master's thesis. I finished my Master's 
        degree with being awarded the equivalent of a British 1st / First class degree."
        />
        <SubParagraph
          text="I decided to move back to Berlin to spend another year with my friends and family, while at the same time applying 
        for a partnership visa for the United Kingdomas at this point my partner - who is from Scotland - and I had already decided that we wanted to start a life together in Scotland. I spent this year working
        ...
        />
        <SubParagraph
          text="As both me and my employer were aware that this employment was alawys set out to be temporary, and my mind was set on developing a potential career that would be easy to transfer to my new home, I had
        ...
        My semesters abroad had a significant impact on my personal interests. Since having spent time in Beijing, I developed a love for authentic south-east Asian and Chinese food, which I try my best to become 
        ...
        mushrooms. This sparked a keen interest in mycology and foraging for mushrooms today is one of my preferred modes of unwinding. My interest in mushrooms intersects with another hobby of mine: whittling, which I took 
